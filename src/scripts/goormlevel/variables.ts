...
export const languages: Record<string, string> = constants.languages.goormlevel;
export const difficultyLabels: Record<string, number> = constants.goormlevelDifficultyLabels;
